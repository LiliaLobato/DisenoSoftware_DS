...
class Construccion:
    ...
    # ¿Qué metodo de refactorización se aplicó aquí? Substitute Algorithm - Refactorizacion
...
class Zombie:
    ...
    #Extract Method - Refactorizacion
    def tiempo_sin_alimento(self): 
        ''' Retorna el tiempo que tiene el zombie desde su ultima comida ''' 
    ...
    #Inline variable - Refactorizacion
    @property
    def estado_de_animo(self):
        ...
        if self.tiempo_sin_alimento() > timedelta(seconds=self.ENFADADO):
            return 'enfadado'
        if self.tiempo_sin_alimento() > timedelta(seconds=self.NORMAL):
            return 'normal'
        else:
            return 'contento'
    
    #Extract variable - Refactorizacion
    @property
    ...
    #Temp with query - Refactorizacion
    ...
    #Split temporary variable - Refactorizacion
    ...
    #Repalce method with method object - Refactorizacion
